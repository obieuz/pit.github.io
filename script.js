...
let dzienna = {
    ...
    download: function (select){
       ...
       show: function (data){
        ...
        let {address} = data
        // document.querySelector(".tempmax").innerHTML="Maximum temperature : "+tempmax+"℃"
        ...
        // document.querySelector(".speed").innerHTML="Wind speed : "+windspeed+"km/h"
        // document.querySelector(".nazwa").innerHTML=address+", "+description
        // document.querySelector(".temp").innerHTML="Temperature : "+temp+"℃"
        // document.querySelector(".actual").innerHTML="Feel like : "+feelslike+"℃"
        ...
        for(i=0;i<15;i++){
            ...
            document.querySelector(".daily").innerHTML+=`<div class="daily-box">
            <div class="first">
